...
public class Course {
    ...
    public Course( int courseId, String courseName, int credits, String description, short semester ) {
    ...
    public String toString() {
        return "Course{" + "courseId=" + courseId + ", courseName=" + courseName + ", credits=" + credits + ", description=" + description + ", semester=" + semester + '}';
    }
